    ...
    <>
      ...
      <SiteLayout contained cta={cta}>
        <article>
          <PageHeader
            title="Mandatory Data Breach Notification Policy"
            subtitle="Last updated: 2024-09-23"
          />

          <section className="typography">
            <p>
              Apsis Labs believes that access to Personal Identifiable
              Information (PII) — especially Personal Health Information (PHI) —
              is a privilege not to be taken lightly. Our customers, and the
              customers of our clients, trust that we will be responsible
              stewards of their data; that we will not abuse our access to
              privately held information for personal gain or malevolent
              purpose.
            </p>
            ...
            <p>
              ...
              belief that any form of PII held by Apsis Labs has been
              compromised by a data breach.
            </p>

            <p>
              The purpose of this policy is to outline how Apsis Labs will
              respond to incidents involving data breaches. It will define the
              steps and procedures that will be followed when those breaches
              occur, and how we will notify our clients or customers of
            ...
            <p>
              <strong>Data Breach</strong>: An incident in which an external
              actor — known or unknown — has gained unauthorized access to PII
              held by Apsis Labs. PII does not include information reasonably
              considered to be public information; information which has been
              voluntarily shared with Apsis Labs for the purpose of sharing with
              third parties; nor does it include information that has been
              previously made public by its owner.
            </p>

            <p>
              Access to information for a legitimate purpose is not to be
              considered a data breach, so long as accessed PII is not used for
              an unlawful or explicitly unauthorized action.
            </p>
            ...
            <p>
              <strong>Personal Health Information</strong>: Apsis Labs defines
            ...
            <blockquote>
              “[I]ndividually identifiable health information" held or
            ...
            <p>
              ...
              <a href="mailto:contact@apsis.io">contact@apsis.io</a>. Examples
              of incidents which should be reported include, but are not limited
              to:
            </p>

            <ul>
              <li>
                Physical or remote access by an unknown individual to any
                resource managed by Apsis Labs
              </li>
              <li>Evidence of access to a system which stores PII or PHI</li>
              <li>
                Unauthorized sharing of credentials which provide access to PII
                or PHI
              </li>
              <li>
                Identification of software bugs which may have provided access
                to PII or PHI
              </li>
              <li>
                Loss or theft of a device which is authorized for access to PII
                or PHI
              </li>
            ...
            <ol>
              ...
              <li>
                <strong>Document</strong> all steps taken during the
                determination and assessment for further review.
              </li>
              <li>
            ...
            <p>
              ...
              our client or customer, or the individual owner of the accessed
              PII, depending on the nature of the data breach, or if another
              mechanism of notice has been previously agreed upon in writing.
            </p>
