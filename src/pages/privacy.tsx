      ...
      <SiteLayout contained cta={cta}>
        <article>
          ...
          <section className="typography">
            <p>
              At <strong>Apsis Labs</strong>, we are dedicated to protecting
              your privacy. This Privacy Policy outlines our practices regarding
              the collection, use, and protection of personal data (“Personal
              Data”) on our website,{" "}
              <a href="https://apsis.io">https://apsis.io</a> (the “Site”),
              software distribute by Apsis Labs, and related materials provided
              via the Site (collectively, the “Site”).
            </p>

            <h3>1. Questions; Contacting Us; Reporting Violations</h3>
            <p>
              If you have questions or concerns regarding our Privacy Policy,
              data collection practices, or if you wish to report any
            ...
            <p>
              ...
              us at <a href="mailto:contact@apsis.io">contact@apsis.io</a>.
            </p>
            ...
            <p>
              ...
              acts as the Controller of your Personal Data under the General
              Data Protection Regulation (GDPR) and related legislation. We
              process your data based on our legitimate interests, which are not
            ...
            <p>
              Your data may be transferred outside of the UK or EEA, in
              accordance with the safeguards under GDPR. You can learn more
              about such transfers at the{" "}
              <a
            ...
            <p>
              ...
              including the United States, where data protection laws may
              differ. We ensure that any transfers comply with Singapore’s
            ...
            <h4>Personal Data</h4>
            <p>
              This includes information such as your name, email, mailing
              address, phone number, and other non-public details linked to your
              identity.
            </p>

            <h4>Anonymous Data</h4>
            <p>
              We also collect Anonymous Data that does not directly identify
              you, such as browsing behavior, device information, and site usage
              data.
            </p>
            ...
            <ul>
              <li>
                <strong>General Use:</strong> Personal Data is used to respond
                to your requests, improve the Site, and communicate with you.
              </li>
              <li>
            ...
            <ul>
              <li>
                <strong>Service Providers</strong> to help us deliver services
                and support.
              </li>
              <li>
            ...
            <p>
              Our Site may link to external websites that operate independently
              of Apsis Labs. We are not responsible for their privacy practices,
            ...
            <p>
              You can request the deletion of your Personal Data. However, we
              may need to retain certain information for legal or operational
              purposes.
            </p>
            ...
            <p>
              ...
              be posted on the Site, and the “Last Updated” date will reflect
              the latest version. Please review this Privacy Policy regularly to
              stay informed.
            </p>
          </section>
        </article>
